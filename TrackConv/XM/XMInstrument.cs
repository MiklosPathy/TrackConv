...
namespace TrackConv.XM
{
    public class XMInstrument
    {
        ...
        public int InstrumentHeaderSize { get { return filedata.ReadAsLittleendianDWord(offset + Consts.InstrumentHeaderSize); } }
        ...
        public int NumberOfSamples { get { return filedata.ReadAsLittleendianWord(offset + Consts.NumberOfSamples); } }
        public int SampleHeaderSize { get { return filedata.ReadAsLittleendianDWord(offset + Consts.SampleHeaderSize); } }
